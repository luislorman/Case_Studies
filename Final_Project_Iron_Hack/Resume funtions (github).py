...
url = "https://docs.google.com/spreadsheets/KEY"
...
url1="https://docs.google.com/spreadsheets/KEY?output=csv"
...
import gspread
import pandas as pd
gc= gspread.service_account(filename = "mKEY.json")
sh= gc.open("Final Project").worksheet("OrderTracker")
...
url1="https://docs.google.com/spreadsheets/KEYcsv"
df_DESDEWEB = pd.read_csv(url1)
...
def One_SKU_Input():
    ...
    url_SKU="https://docs.google.com/spreadsheets/KEY6"
...
###aqui     
    ...
    #        
            ...
            url_PO="https://docs.google.com/spreadsheets/KEY5"
...
url1="https://docs.google.com/spreadsheetKEYpub?output=csv"
df_DESDEWEB = pd.read_csv(url1)
